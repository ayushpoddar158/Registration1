...
const Registrationedit = ({ editedData }) => {
  let name, value;
  const [obj, setObj] = useState({
    name: editedData.FirstName,
    lastname: editedData.LastName,
    dob: editedData.DOB,
    study: editedData.Study,
    startdate: editedData.StartDate,
    enddate: editedData.EndDate,
    currentsal: editedData.CurrentSalary,
  ...
  return (
    <div className="div">
      <b className="employee-registration-form">
        Edit Employee Registration Form
      </b>
      <div className="child" />
      <div className="item" />
